        ...
        <Grid container className="mt-4">
            ...
            <Grid container>
                        <Grid item xs={12} sm={8} className="mt-3 ml-2">
                            <Typography>Menampilkan 2394316 produk untuk bengkel (1 - 60 of 2394316)</Typography>
                        </Grid>
                            ...
                            <Grid container>
                                ...
                                <FormControl sx={{ m: 1, minWidth: 150 }} size="small">
                                    ...
                                    >
                                        ...
                                        <MenuItem value={30}>Bengkel Mobil</MenuItem>
                                        <MenuItem value={40}>Bengkel Motor</MenuItem>
                                        <MenuItem value={50}>Bengkel Resmi</MenuItem>
                                    </Select>
                                 </FormControl>  
                                </Grid>
                            </Grid>
